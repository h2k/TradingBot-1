...
def update_news():
    ...
    return html.Div(
        children=[
            html.P(className="p-news", children="Actualités Bloomberg Monde"),
            html.P(
...
def get_top_bar(user="Test", balance=50000, equity=50000, margin=0, fm=50000, m_level="%", open_pl=0):
    return [
        get_top_bar_cell("Utilisateur", user),
        get_top_bar_cell("Solde utilisateur", balance),
        get_top_bar_cell("Taux de marge", m_level),
        get_top_bar_cell("Positonnement P/L", open_pl),
    ]
                        ...
                        children=[
                            dcc.Checklist(
                                ...
                                options=[
                                    ...
                                    {"label": "Points pivots", "value": "pp_trace"},
                                    {
                                        "label": "Oscillateur stochastique",
                                        "value": "stoc_trace",
                                    },
                                    {
                                        "label": "Indicateur momentum",
                                        "value": "mom_trace",
                                    },
                                ],
                                value=[],
                        ...
                        children=[
                            dcc.RadioItems(
                                ...
                                options=[
                                    ...
                                    {"label": "Montagnes", "value": "area_trace"},
                                    {"label": "Barres", "value": "bar_trace"},
                                    {
                                        "label": "Barres colorées",
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=html.Button(
                            "Ordre", id=pair + "button_order", n_clicks=0
                        ),
                    ),
                ],
            )
        ...
        html.Div(
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        html.Img(
                            className="logo", src=app.get_asset_url("logotype-pooltrade.png")
                        ),
                        html.H6(className="title-header", children="PoolTrade"),
                        html.P(
                            """
                            Dashboard privé pour l'application PoolTrade
                            """
                        ),
                    ],
                ),
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.P(className="three-col", children="Vente"),
                        html.P(className="three-col", children="Achat"),
                        html.Div(
                            id="pairs",
                        ...
                        html.I("Rechercher un stock : "),
                        dcc.Input(className="three-col", id="search_input", type="text", placeholder="AMZN"),
                        ...
                        html.Div(
                            ...
                            children=[
                                dcc.Dropdown(
                                    ...
                                    options=[
                                        {"label": "Positions ouvertes", "value": "open"},
                                        {
                                            "label": "Positions cloturées",
                                            "value": "closed",
                                        },
                                    ],
                                    value="open",
...
# Search a stock or value
@app.callback(
    Output("search-result", "children"),
    [Input("search_input", "value")],
)
def update_search(search_input):
    return f'Un résultat : {search_input}'
    ...
    if orders is not None:
        ...
        for order in orders:
            ...
            if order["status"] == "open":
                openOrders += 1
    return [
        {"label": "Positions ouvertes (" + str(openOrders) + ")", "value": "open"},
        {"label": "Positions cloturées (" + str(closeOrders) + ")", "value": "closed"},
    ]
...
def update_top_bar(orders):
    ...
    return get_top_bar("Test", balance, equity, margin, free_margin, margin_level, open_pl)
