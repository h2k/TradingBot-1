...
class TestAlphaVantage(unittest.TestCase):
    ...
    def test_handle_api_call(self):
        ...
        """
        av = alpha_vantage.AlphaVantage(key=TestAlphaVantage._API_KEY_TEST)
    ...
    def test_time_series_intraday(self):
        """ Test that api call returns a json file as requested
        """
        ts = alpha_vantage.TimeSeries(key=TestAlphaVantage._API_KEY_TEST)
    ...
    def test_time_series_intraday_pandas(self):
        """ Test that api call returns a json file as requested
        """
        ts = alpha_vantage.TimeSeries(key=TestAlphaVantage._API_KEY_TEST, output_format='pandas')
        data, _ = ts.get_intraday(TestAlphaVantage._EQ_NAME_TEST, interval='1min', outputsize='full')
    ...
    def test_time_series_intraday_date_indexing(self):
        ...
        """
        ts = alpha_vantage.TimeSeries(key=TestAlphaVantage._API_KEY_TEST, output_format='pandas', indexing_type='date')
        data, _ = ts.get_intraday(TestAlphaVantage._EQ_NAME_TEST, interval='1min', outputsize='full')
    ...
    def test_time_series_intraday_date_integer(self):
        ...
        """
        ts = alpha_vantage.TimeSeries(key=TestAlphaVantage._API_KEY_TEST, output_format='pandas', indexing_type='integer')
        data, _ = ts.get_intraday(TestAlphaVantage._EQ_NAME_TEST, interval='1min', outputsize='full')
    ...
    def test_technical_indicator_sma_python3(self):
        """ Test that api call returns a json file as requested
        """
        ti = alpha_vantage.TechIndicators(key=TestAlphaVantage._API_KEY_TEST)
    ...
    def test_technical_indicator_sma_pandas(self):
        """ Test that api call returns a json file as requested
        """
        ti = alpha_vantage.TechIndicators(key=TestAlphaVantage._API_KEY_TEST, output_format='pandas')
        data, _ = ti.get_sma(TestAlphaVantage._EQ_NAME_TEST, interval='15min', time_period=10, series_type='close')
        self.assertIsInstance(data, df, TestAlphaVantage._ERROR_MUST_BE_PANDAS)
    ...
    def test_sector_perfomance(self):
        """ Test that api call returns a json file as requested
        """
        sp = alpha_vantage.SectorPerformances(key=TestAlphaVantage._API_KEY_TEST)
    ...
    def test_sector_perfomance_pandas(self):
        """ Test that api call returns a json file as requested
        """
        sp = alpha_vantage.SectorPerformances(key=TestAlphaVantage._API_KEY_TEST, output_format='pandas')
        data, _ = sp.get_sector()
        self.assertIsInstance(data, df, TestAlphaVantage._ERROR_MUST_BE_PANDAS)
    ...
    def test_foreign_exchange(self):
        """ Test that api call returns a json file as requested
        """
        fe = alpha_vantage.ForeignExchange(key=TestAlphaVantage._API_KEY_TEST)
    ...
    def test_crypto_currencies_pandas(self):
        """ Test that api call returns a json file as requested
        """
        cc = alpha_vantage.CryptoCurrencies(key=TestAlphaVantage._API_KEY_TEST, output_format='pandas')
