...
class SectorPerformances(av):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.output_format.lower() == 'csv':
            raise ValueError("Output format {} is not compatible with the SectorPerformances class".format(
    ...
    def _output_format_sector(func, override=None):
        ...
        def _format_wrapper(self, *args, **kwargs):
            ...
            if output_format == 'json':
                ...
                col_names = [re.sub(r'\d+.', '', name).strip(' ') for name in list(data_pandas)]
    ...
    def get_sector(self):
        """Returns the realtime and historical sector performances.
