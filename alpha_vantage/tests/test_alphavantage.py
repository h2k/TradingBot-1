from alpha_vantage import (
    AlphaVantage, TimeSeries, TechIndicators, CryptoCurrencies, SectorPerformances, ForeignExchange
)
from pandas import DataFrame as df
import unittest


# TODO : Split tests in multiple classes
# TODO : Find a way to test data content more specifically
class TestAlphaVantage(unittest.TestCase):
    _API_KEY_TEST = '84WDI082Z0HOREL6'
    # Microsoft (MSFT)
    _EQ_NAME_TEST = 'MSFT'
    # Currency (XRP for Come ;) )
    ...
    def test_crypto_currencies(self):
        ...
        data, _ = cc.get_digital_currency_intraday(symbol=TestAlphaVantage._CRYPTO_NAME_TEST,
    ...
    def test_crypto_currencies_pandas(self):
        ...
        data, _ = cc.get_digital_currency_daily(symbol="BTC", #TestAlphaVantage._CRYPTO_NAME_TEST,
                                                   market=TestAlphaVantage._FIAT_NAME_TEST)
        with open('bitcoin-prices.csv', 'w+') as out:
